...
export function LearnMore() {
  return (
    <div className="h-[calc(100svh-var(--nav-h))] overflow-y-auto snap-y snap-mandatory scroll-smooth">
      {/* SECTION 1 – INTRO */}
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex items-center justify-center px-6 max-w-4xl mx-auto text-black ">
        <FadeInWhenVisible>
          <h2 className="font-heading text-3xl md:text-5xl tracking-wider uppercase text-center -translate-y-6">
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex flex-col items-center justify-center px-6 max-w-3xl mx-auto space-y-10 text-lg leading-relaxed text-black ">
        <FadeInWhenVisible>
          <p className="text-2xl md:text-4xl leading-snug max-w-3xl -translate-y-6">
        ...
        <FadeInWhenVisible>
          <div className="flex flex-col md:flex-row justify-end gap-10 md:gap-24 items-center md:items-start text-right">
            <img
              ...
              alt="Home icon"
              className="w-32 h-32 md:w-44 md:h-44 flex-shrink-0 -translate-y-6"
            />
            <p className="text-2xl md:text-4xl leading-snug max-w-xl -translate-y-6">
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex flex-col items-center justify-center px-6 max-w-3xl mx-auto text-center text-lg leading-relaxed text-black space-y-6 ">
        <FadeInWhenVisible>
          <p className="text-2xl md:text-4xl leading-snug max-w-2xl mx-auto -translate-y-6">
        ...
        <FadeInWhenVisible>
          <img
            src={`${import.meta.env.BASE_URL}bank-icon.png`}
            alt="Bank icon"
            className="w-40 h-auto mx-auto -translate-y-6"
          />
        </FadeInWhenVisible>
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          <ChevronDown size={64} className="text-green-800 animate-bounce" />
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex flex-col justify-center items-center px-6 py-16 max-w-3xl mx-auto text-center text-lg leading-relaxed text-black space-y-6 ">
        <img
          src={`${import.meta.env.BASE_URL}dollar-icon.png`}
          alt="Dollar icon"
          className="place-self-end w-24 h-24 md:w-32 md:h-32 rotate-[30deg] -translate-y-6"
        />
        <FadeInWhenVisible>
        ...
        <div className="absolute bottom-4 flex justify-center w-full">
          <ChevronDown size={64} className="text-green-800 animate-bounce -translate-y-6" />
        </div>
        <img
          src={`${import.meta.env.BASE_URL}dollar-icon.png`}
          alt="Dollar icon"
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex flex-col justify-center px-6 max-w-3xl mx-auto text-lg leading-relaxed text-black space-y-12 ">
        <FadeInWhenVisible>
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            <img
              src={`${import.meta.env.BASE_URL}check-icon.png`}
              alt="Check icon"
              className="w-32 h-32 md:w-40 md:h-40 object-contain -translate-y-6"
            />
            <p className="text-2xl md:text-4xl leading-snug max-w-2xl text-center md:text-right -translate-y-6">
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center relative flex justify-center items-center max-w-3xl mx-auto px-6 text-black ">
        <FadeInWhenVisible>
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 w-full">
            <div className="space-y-6 max-w-xl">
              <p className="text-2xl md:text-4xl leading-snug text-center md:text-left -translate-y-6">
            ...
            <img
              ...
              alt="Graph icon"
              className="w-[200px] h-[200px] md:w-[240px] md:h-[240px] flex-shrink-0 -translate-y-6"
            />
          </div>
        </FadeInWhenVisible>
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          ...
          <div className="w-full text-center space-y-3">
            ...
            <div className="flex justify-center">
              <img
                ...
                alt="USA icon"
                className="w-[250px] h-[250px] object-contain -translate-y-6"
              />
            </div>
          </div>
        </FadeInWhenVisible>
      ...
      <section className="h-[calc(100svh-var(--nav-h))] snap-center flex items-center justify-center px-6 text-black ">
        <FadeInWhenVisible>
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-16 text-center w-full">
            <h2 className="font-heading text-3xl md:text-5xl tracking-wider uppercase -translate-y-6">
              <strong>YOU</strong> can help end <br />
              <span className="font-bold">UNNECESSARY PMI.</span>
            </h2>

            <div className="flex flex-col gap-8 pt-1 items-center text-left w-full -translate-y-6">
              {/* Row 1 */}
